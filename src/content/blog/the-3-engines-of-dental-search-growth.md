...
faqs:
  - question: "What are the three engines of dental search growth?"
    answer: "The three engines are: (1) Google Maps/GBP + reviews, which captures the most patient calls, (2) local organic pages targeting service + city keywords, and (3) authority signals like backlinks and content depth that build long-term ranking power. Everything else — social media, email, print — is either supporting or distracting."
  - question: "Is Google Business Profile more important than a dental website?"
    answer: "For generating phone calls, yes — in most markets, GBP drives more direct patient contacts than the website itself. A mediocre website backed by 200 five-star reviews and an optimized GBP will outperform a beautiful website with 10 reviews and a neglected profile. But a strong website amplifies your GBP performance, so both matter."
  - question: "Should dental practices invest in social media marketing?"
    answer: "Social media can support your brand, but it rarely drives new patient acquisition directly. Most patients find their dentist through Google search, not Instagram. Social media is fine as a supplementary channel, but if you're choosing between optimizing your GBP and posting on social media, the GBP will generate more patients every time."
...
This is where a properly built website becomes a genuine growth asset. Not a digital brochure — a search engine that captures patients at every stage of their decision process. It's exactly what we focus on at [Groundwork Dental](/dental-seo-foundation) when building out a practice's search foundation.
