...
faqs:
  ...
  - question: "How do I rank for treatment research keywords?"
    answer: "Create deep, authoritative content that answers the specific questions patients are asking: cost breakdowns, procedure comparisons, recovery timelines, before/after expectations. Build topic clusters around each major treatment rather than single thin pages."
...
1. Build a template WordPress site
2. Optimize for "[service] + [city]" keywords
3. Set up Google Business Profile
4. Maybe write a few generic blog posts ("5 Tips for Healthy Teeth")
5. Charge $300-500/month forever
...
**Layer 1: Research (top of funnel)**
Patient searches: "how much do dental implants cost," "Invisalign vs braces," "do veneers look natural"
Your job: Be the most helpful, authoritative answer. Build trust before they ever search for a provider.

**Layer 2: Comparison (middle of funnel)**
Patient searches: "best implant dentist [city]," "cosmetic dentist reviews [city]"
Your job: Show up with strong reviews, case examples, and a website that doesn't look like it was built in 2015.

**Layer 3: Decision (bottom of funnel)**
Patient searches: "dentist near me," "[practice name] reviews"
Your job: Be easy to find, easy to contact, and not embarrassing when they Google your name.
