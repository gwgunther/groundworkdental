...
faqs:
  ...
  - question: "How do I get my domain back from my website agency?"
    answer: "If the domain is registered in the agency's name, you'll need to request a domain transfer. Most agencies will cooperate (it's legally your practice name). If they refuse, ICANN has a dispute process. Start by checking WHOIS to see who the registrant is, then contact the agency in writing requesting the transfer."
  - question: "How long does it take to switch dental website providers?"
    answer: "If you have a new site ready to go, the technical switch (DNS change) takes 24-48 hours. Building the replacement site takes 1-8 weeks depending on the provider. The full process — from deciding to switch to having your new site live — typically takes 4-10 weeks."
  - question: "What should I secure before leaving my dental website agency?"
...
For a more detailed comparison of what different types of dental website providers offer and how they stack up, [compare your options](/compare).
