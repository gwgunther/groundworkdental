...
1. Build a template website (cost to agency: a few hundred dollars)
2. Set up GBP (one-time task)
3. Submit directory citations (one-time task, often automated)
4. Charge you $300-500/month indefinitely for "management"
...
If you want to see what a site built for growth (not just baseline) actually looks like, [check out our example builds](/example). And if you're curious what it costs to build something that actually grows, the [pricing page](/pricing) lays it out transparently — no "call for a quote" nonsense.
