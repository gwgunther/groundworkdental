...
faqs:
  ...
  - question: "What should a dental SEO agency report include?"
    answer: "Meaningful reports should include actual keyword ranking changes (for specific terms, not just your practice name), organic traffic trends from Google Analytics, Google Business Profile performance (calls, direction requests, views), new backlinks acquired, and content published. If the report is just a PDF with green arrows and no actionable data, it's a vanity report."
  - question: "How much should dental SEO cost per month?"
    answer: "Legitimate ongoing dental SEO ranges from $500-3,000/month depending on the scope. Below $500/month, there's not enough budget to do meaningful work. Above $3,000/month, you should be getting aggressive content creation, backlink outreach, and measurable growth. Always ask exactly what deliverables you're getting for the price."
  - question: "Can I do dental SEO myself instead of hiring an agency?"
    answer: "You can handle some aspects yourself — especially Google Business Profile optimization and review generation. But technical SEO, content strategy, and backlink building require expertise and time most dentists don't have. The key is owning your foundation (domain, hosting, website files) so you're never dependent on any single provider."
  - question: "What questions should I ask a dental SEO agency before hiring them?"
