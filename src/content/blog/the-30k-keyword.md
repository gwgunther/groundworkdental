...
faqs:
  - question: "Why is 'dental implant cost' more valuable than 'dentist near me' for SEO?"
    answer: "Someone searching 'dentist near me' typically needs a cleaning or exam worth $100-300. Someone searching 'dental implant cost' is researching a procedure worth $5,000-40,000. Even though the search volume is lower, the case value per patient is 10-100x higher, making treatment research keywords dramatically more valuable for your practice."
  - question: "How does Google show local results for searches that don't include a city name?"
    answer: "Google uses the searcher's IP address, device location, and search history to determine their location and inject geographically relevant results. When someone in your city searches 'dental implant cost,' Google surfaces local dental practices in the results — even though the user never typed their city name. This is called implicit local intent."
  - question: "What percentage of healthcare searches start with research, not provider lookups?"
    answer: "Studies consistently show that 80-90% of healthcare searches are informational — patients searching for symptoms, conditions, treatment options, and costs. Only 10-20% of healthcare searches are provider-specific lookups like 'dentist near me.' Most dental SEO strategies only target that small slice."
  - question: "What kind of content ranks for treatment research keywords?"
    answer: "Comprehensive, detailed pages that genuinely answer patient questions: cost breakdowns with price ranges, procedure explanations, comparison guides (implants vs bridges), recovery timelines, and FAQ clusters addressing real concerns. Thin pages with a paragraph of text and a stock photo won't compete."
  - question: "How long does it take to rank for dental treatment keywords?"
    answer: "Treatment research keywords are more competitive than local service keywords, so expect 6-12 months of consistent content building before seeing meaningful rankings. The tradeoff is worth it — a single patient from a treatment research keyword can be worth $5,000-40,000 compared to a few hundred dollars from generic searches."
  - question: "Why don't most dental marketing agencies target treatment research keywords?"
    answer: "Targeting treatment research keywords requires creating deep, original content — comprehensive procedure pages, cost guides, comparison articles, and FAQ clusters. This is significantly more work than the template-based approach most agencies use. The agency's business model depends on low per-client effort, so they default to template pages and basic local SEO instead."
---
